if __name__ == '__main__':
    ...
    from Recommender_System.algorithm.DeepFMGCN.model import MKR_model
    ...
    model_rs, model_kge = MKR_model(n_user, n_item, n_entity, n_relation, dim=4, L=5, H=1, l2=1e-6)
